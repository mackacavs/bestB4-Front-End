...
const Recipe = ({ addRecipe, post: { posts, userPosts }, auth: { user }, recipe }) => {
  ...
  if (recipe.recipes){
    return (
      ...
      <a href={"https://www.google.com/search?q=" + recipe.recipes[0].title.replace(/ /g,'+')}>
      ...
      <a href={"https://www.google.com/search?q=" + recipe.recipes[1].title.replace(/ /g,'+')}>
      ...
      <a href={"https://www.google.com/search?q=" + recipe.recipes[2].title.replace(/ /g,'+')}>
